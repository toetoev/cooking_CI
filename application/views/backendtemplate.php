...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item">
        		<a class="nav-link" href="<?=base_url('Category_ctrl')?>">
      		...
      		<li class="nav-item">
        		<a class="nav-link" href="<?=base_url('Country_ctrl')?>">
         			<i class="fas fa-flag" aria-hidden="true"></i>
         			<span>Countires</span>
         		</a>
      		</li>
      		<li class="nav-item">
        		<a class="nav-link" href="<?=base_url('Ingredient_ctrl')?>">
         			<i class="fas fa-pepper-hot" aria-hidden="true"></i>
         			<span>Ingredients</span>
         		</a>
      		</li>
      		<li class="nav-item">
        		<a class="nav-link" href="<?=base_url('Meal_ctrl')?>">
