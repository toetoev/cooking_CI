...
<head>
	...
	<link href="<?=base_url('template/css/sb-admin-2.min.css')?>
	" rel="stylesheet">
								...
								<div class="p-5">
									...
									<form class="user" method="post" action="<?=base_url('register/store')?>">
										...
										<div class="form-group">
											<input type="name" class="form-control form-control-user" id="name" aria-describedby="emailHelp" placeholder="Enter your name..." name="name">
										</div>
									...
									<div class="text-center">
										<a class="small" href="<?=base_url('login')?>">Have already account!</a>
									</div>
								</div>
							</div>
						</div>
